...
void enigme(SDL_Surface *ecran,int a)
{FILE *f=NULL;
f=fopen("compi.txt","w");
    fprintf(f,"Init SDL.\n");
 fprintf(f,"il ya erreur : %d",a);
    char im[100];
...
FILE *f=NULL;
    ...
    positionim.x =  0 ;
    positionim.y =  0 ;
    sprintf(im,"the answer is: /%d.png",a);
    image= IMG_Load(im);
    sprintf(im1,"the answer is/%d/1.png",a);
    sprintf(im2,"the answer is/%d/2.png",a);
    sprintf(im3,"the answer is/%d/3.png",a);
    sprintf(im4,"the answer is/%d/4.png",a);
    image1= IMG_Load(im1);
    image2= IMG_Load(im2);
    image3= IMG_Load(im3);
    image4= IMG_Load(im4);
